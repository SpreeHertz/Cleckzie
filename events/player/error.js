    ...
    switch (error) {
        ...
        case 'NotPlaying':
            const notPlayingEmbed = new MessageEmbed()
                .setDescription(`${client.config.emojis.error} There is no music being played on the server.`)
                .setColor("#FF0000")
        ...
        case 'NotConnected':
            const NotConnectedEmbed = new MessageEmbed()
                .setDescription(`${client.config.emojis.error} You aren't connected to any voice channel. Please connect one first.`)
                .setColor("#FF0000")
        ...
        case 'UnableToJoin':
            const UnableToJoinEmbed = new MessageEmbed()
                .setDescription(`${client.config.emojis.error} I am unable to join your voice channel. Please check my permissions!`)
                .setColor("#FF0000")
        ...
        case 'VideoUnavailable':
            const VideoUnavailableEmbed = new MessageEmbed()
                .setDescription(`${client.config.emojis.error} ${args[0].title} is not avaible in your country. Skipping...`)
                .setColor("#FF0000")
        ...
        default:
            const defaultErrorEmbed = new MessageEmbed()
                .setTitle(`${client.config.emojis.error} An error had occured!`)
