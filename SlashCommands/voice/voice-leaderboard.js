...
module.exports = {
	...
	run: async (client, interaction, args, message) => {
		...
		if (fetchNumber > 50) return interaction.channel.send({ content: `The bot cannot fetch more than 50 users' leaderboard. Please try a lower number.`, ephemeral: true });
